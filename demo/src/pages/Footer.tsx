...
<footer className=" bg-slate-800 dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <ul className=" text-slate-300 dark:text-gray-400 font-medium">
                <li className="mb-4">
    ...
    <div className="px-4 py-6 bg-gray-700 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-100 dark:text-gray-300 sm:text-center">© 2023 <a href="">Shiroya</a>. All Rights Reserved.
        </span>
